...
public class WXSlider extends WXVContainer<FrameLayout> {
	...
	protected FrameLayout initComponentHostView(@NonNull Context context) {
		...
		// init view pager
		FrameLayout.LayoutParams pagerParams = new FrameLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
	...
	protected boolean setProperty(String key, Object param) {
		...
		case Constants.Name.INDEX:
			...
			return true;
		case Constants.Name.OFFS_CREEN_PAGE_LIMIT:
			Integer offScreenPageLimit = WXUtils.getInteger(param, null);
			if (offScreenPageLimit != null && mViewPager != null) {
		...
		case Constants.Name.SCROLLABLE:
			...
			return true;
		case Constants.Name.NEEDLOOP:
			boolean needLoop = WXUtils.getBoolean(param, true);
			if (mViewPager != null && mAdapter != null) {
				mViewPager.setCircle(needLoop);
				mAdapter.setNeedLoop(needLoop);
			}
			return true;
		}
	...
	public void setIndex(int index) {
		if (mViewPager != null && mAdapter != null) {
			...
			if (mIndicator != null && mIndicator.getHostView() != null && mIndicator.getHostView().getRealCurrentItem() != index) {
	...
	protected class SliderPageChangeListener implements OnPageChangeListener {
		...
		public void onPageSelected(int pos) {
			...
			if (event.contains(Constants.Event.CHANGE) && WXViewUtils.onScreenArea(getHostView())) {
				...
				WXSDKManager.getInstance().fireEvent(getInstanceId(), ref, Constants.Event.CHANGE, params, domChanges);
			}
